...
#df=df.loc[df['Hotel_Name'] == 'Britannia International Hotel Canary Wharf']
hName = 'DoubleTree by Hilton Hotel London Tower of London'

df=df.loc[df['Hotel_Name'] == 'DoubleTree by Hilton Hotel London Tower of London']
...
def update_graphs(row_ids, selected_row_ids, active_cell):
    ...
    dff = dff[dff.groupby('Reviewer_Nationality').Reviewer_Nationality.transform('count')>5]
     ...
     html.Div([
        html.Div([
            ...
            dcc.Graph(
                ...
                figure = px.pie(dff_sentiment, names='sentiment', hole=.3),
            ),
        ], className="six columns"),
